...
contract GotCrowdSale is CrowdsaleBase {
    ...
    /*** CONSTANTS ***/
    uint256 public constant START_TIME = 1527066712;                     // 12 June 2018 09:00:00 GMT
    uint256 public constant END_TIME = 1528068712;                       // 26 June 2018 09:00:00 GMT
    //Token allocation
    ...
    function initPGOMonthlyInternalVault(address[] beneficiaries, uint256[] balances) public onlyOwner {
        ...
        pgoMonthlyInternalVault.init(beneficiaries, balances, MONTHLY_INTERNAL_VAULT_CAP, token);
